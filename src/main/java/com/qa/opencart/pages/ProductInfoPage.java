...
public class ProductInfoPage {
	...
	private By productImages = By.cssSelector("div#content ul.thumbnails img");
	...
	private By itemsInCart = By.cssSelector("div#cart");
	...
	private void getProductPriceData() {
        ...
        productInfoMap.put("extraprice", exPrice);
	}
	...
	public boolean addProductToCart(String qty) {
	     eleUtil.doSendKeys(this.qty, qty);
	     eleUtil.doClick(addToCartBtn);
	     if(getProductAddCartSuccessMessage().contains(Constants.SHOPPING_CART_SUCCESS_MESSAGE))
	         return true;
	     return false;
	     
	}
	
	public String getProductAddCartSuccessMessage()
	{
		return eleUtil.waitForElementToBeVisible(successMessage, Constants.DEFAULT_TIME_OUT).getText();
	}
	
	public ShoppingCartPage viewCartItems()
	{
		eleUtil.doClick(itemsInCart);
